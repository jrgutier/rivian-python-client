...
class CabinVentilationSetting(_message.Message):
    ...
    def __init__(self, enabled: _Optional[bool] = ..., mode: _Optional[str] = ..., windows_open_percent: _Optional[int] = ..., sunroof_open_percent: _Optional[int] = ..., duration_minutes: _Optional[int] = ...) -> None: ...
