...
class Wheel(_message.Message):
    __slots__ = (
        "wheel_package",
        "tire_odometer_mileage_meters",
        "saved_tire_odometer_mileage_delta_meters",
        "odometer_at_last_rotation_meters",
        "saved_odometer_at_last_rotation_delta_meters",
        "rotation_reminder_interval_meters",
        "is_installed",
        "timestamp",
        "tires",
    ...
    def __init__(
        self,
        wheel_package: _Optional[int] = ...,
        tire_odometer_mileage_meters: _Optional[int] = ...,
        saved_tire_odometer_mileage_delta_meters: _Optional[int] = ...,
        odometer_at_last_rotation_meters: _Optional[int] = ...,
        saved_odometer_at_last_rotation_delta_meters: _Optional[int] = ...,
        rotation_reminder_interval_meters: _Optional[int] = ...,
        is_installed: bool = ...,
        timestamp: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        tires: _Optional[int] = ...,
        current_odometer_meters: _Optional[int] = ...,
    ) -> None: ...
...
class VehicleWheels(_message.Message):
    ...
    def __init__(
        self, wheels_list: _Optional[_Iterable[_Union[Wheel, _Mapping]]] = ...
    ) -> None: ...
...
class OtaRepeatsDaily(_message.Message):
    ...
    def __init__(
        self,
        starts_at_min: _Optional[int] = ...,
        geofence: _Optional[_Union[OtaGeofence, _Mapping]] = ...,
    ) -> None: ...
...
class OtaSchedule(_message.Message):
    ...
    def __init__(
        ...
        id: _Optional[str] = ...,
        is_enabled: bool = ...,
        repeats_daily: _Optional[_Union[OtaRepeatsDaily, _Mapping]] = ...,
        single_occurrence: _Optional[_Union[OtaSingleOccurrence, _Mapping]] = ...,
    ) -> None: ...
...
class OtaConfig(_message.Message):
    ...
    def __init__(
        self,
        schedules: _Optional[_Iterable[_Union[OtaSchedule, _Mapping]]] = ...,
        timestamp: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
    ) -> None: ...
...
class HalloweenCelebrationSettings(_message.Message):
    __slots__ = (
        ...
        "exterior_sounds_muted",
        "light_show_enabled",
        "interior_overhead_lights_enabled",
        "exterior_light_show_enabled",
        "lights_color",
        "car_costume_availability",
        "motion_light_sound_enabled",
    )
    ...
    def __init__(
        self,
        costume_theme: _Optional[_Union[HalloweenCostumeTheme, _Mapping]] = ...,
        celebration_sound_volume: _Optional[_Union[Int32Value, _Mapping]] = ...,
        music_enabled: _Optional[_Union[BoolValue, _Mapping]] = ...,
        music_type: _Optional[_Union[StringValue, _Mapping]] = ...,
        sound_effect: _Optional[_Union[StringValue, _Mapping]] = ...,
        exterior_sound_effect: _Optional[int] = ...,
        exterior_sounds_muted: _Optional[_Union[BoolValue, _Mapping]] = ...,
        light_show_enabled: _Optional[_Union[BoolValue, _Mapping]] = ...,
        interior_overhead_lights_enabled: _Optional[_Union[BoolValue, _Mapping]] = ...,
        exterior_light_show_enabled: _Optional[_Union[BoolValue, _Mapping]] = ...,
        lights_color: _Optional[_Union[StringValue, _Mapping]] = ...,
