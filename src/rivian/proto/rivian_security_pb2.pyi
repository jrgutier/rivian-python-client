...
class PassiveEntryStatus(_message.Message):
    ...
    def __init__(self, allow_passive_entry_via_bluetooth_while_in_ccc: _Optional[bool] = ..., ccc_passive_permission_status: _Optional[_Union[CccPassivePermissionStatus, str]] = ...) -> None: ...
